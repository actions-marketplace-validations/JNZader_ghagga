...
--> statement-breakpoint
ALTER TABLE "github_user_mappings" DROP CONSTRAINT IF EXISTS "github_user_mappings_installation_id_installations_id_fk";--> statement-breakpoint
...
ALTER TABLE "memory_observations" DROP CONSTRAINT IF EXISTS "memory_observations_session_id_memory_sessions_id_fk";--> statement-breakpoint
...
ALTER TABLE "repositories" DROP CONSTRAINT IF EXISTS "repositories_installation_id_installations_id_fk";--> statement-breakpoint
...
ALTER TABLE "reviews" DROP CONSTRAINT IF EXISTS "reviews_repository_id_repositories_id_fk";--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_user_mappings_github_user" ON "github_user_mappings" USING btree ("github_user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_observations_project" ON "memory_observations" USING btree ("project");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_observations_topic_key" ON "memory_observations" USING btree ("topic_key");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_observations_type" ON "memory_observations" USING btree ("type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_observations_content_hash" ON "memory_observations" USING btree ("content_hash");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_memory_sessions_project" ON "memory_sessions" USING btree ("project");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_repositories_installation" ON "repositories" USING btree ("installation_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_repositories_full_name" ON "repositories" USING btree ("full_name");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reviews_repository" ON "reviews" USING btree ("repository_id");--> statement-breakpoint
